...
def quen_extract_text_from_ic_image(quen3_mdl, image_path):
...
def main(): 
    for img_filepath, expected_output in tests: 
        ...
        txt = quen_extract_text_from_ic_image('qwen3-vl:235b-cloud', img_filepath)
        test_extracted_text(txt, expected_output)   
